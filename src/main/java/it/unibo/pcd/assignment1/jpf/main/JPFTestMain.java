...
public class JPFTestMain {
    ...
    public static void main(String[] args) {
        ...
        final TaskListFactory taskListFactory = new TaskListFactory(DOCUMENTS_NUMBER,WORDS_FOR_PAGE,PAGES_FOR_DOCUMENT,PIPES_SIZE, updates, taskCounter);
        Stream.concat(Stream.of(new AgentImpl(taskListFactory.createForGeneratorAgent()),
                new AgentImpl(Collections.singletonList(new UpdateSinkTask(updates,taskCounter, DOCUMENTS_NUMBER*PAGES_FOR_DOCUMENT*WORDS_FOR_PAGE)))),
